...
from thseq.criterions.fairseq_criterion import FairseqCriterion

CRITERION_REGISTRY = {}
CRITERION_CLASS_NAMES = set()


def build_criterion(args, target_dictionary):
    return CRITERION_REGISTRY[args.criterion](args, target_dictionary)
...
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith('.py') and not file.startswith('_'):
        ...
        importlib.import_module('thseq.criterions.' + module)
